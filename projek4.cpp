...
int main(int argc, char const *argv[])
{
    ...
    else if (pilut == 'B')
    {
        ...
        if (passwordDokter == passwordAdmin)
        {
            ...
            ifstream dataBasePasien("daBasePasien.txt");
            if (dataBasePasien.is_open())
            {
                string line;
                while (getline(dataBasePasien, line))
                {
                    cout << line << endl;
                }
                dataBasePasien.close();
            }
            else 
            {
                cout << "Tidak dapat membuka file daBasePasien.txt" << endl;
            }
        }
        else
        {
